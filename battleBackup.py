...
def playerPoisonEffect():
    ...
    if playerStatusCount > 0:
        print(Fore.GREEN + "The serpent poisoned you! You will lose 1 health every turn.")
        playerHealth -= 1
        playerStatusCount -= 1
...
def curseEffect():
    ...
    if playerStatusCount >= 1:
        print(Fore.MAGENTA + Style.DIM + "You will die from curse in", str(playerStatusCount), "turns." +s+n)
        time.sleep(1)
...
def playerFireEffect():
    ...
    playerStatusCount = 3
    if playerStatusCount > 0:
        print("The dragon burned you, your lost 2 health and your max health has been reduced by 1!")
        playerHealth -= 2
        maxHealth -= 1
        #playerStatusCount -= 1
...
def playerFreezeEffect():
    ...
    if damage > 1:
      damage -= 1
      print("Your damage has been reduced by 1!")

#Defining battle()
def battle():
    global count, scaling, scalecount
    global enemyNum, enemy, enemyHealth, enemyDamage, enemyHitMessage, playerCoins, healPotions, curse, enemyStatusCount, playerStatusCount, curseCount, enemyPoisonCount, enemyFireCount, enemyCoinSteal, damage
    ...
    while enemyHealth > 0 or playerHealth > 0:
        ...
        if selection == 5:
            ...
            if save == 1:
                ...
                f.write(str(classType) + "," + str(playerHealth) + "," + str(maxHealth) + "," + str(damage) + "," + str(count) + "," + str(dificulty) + "," + str(playerCoins) + "," + str(healPotions))
                f.close()
...
def store():
    ...
    while True:
        print("\nBalance:", Fore.YELLOW + str(playerCoins) +s,"\n1. +1", Fore.BLUE + "Max health" +s, "(5 coins)\n2. +1",Fore.RED + "Damage upgrade" + s, "(5 coins) \n3. +1", Fore.GREEN + "Health potion"+s, "(3 coins,", str(healPotions), "in your inventory)", "\n4. Exit")
